        ...
        <div className="min-h-screen bg-retro-ink flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <h1 className="font-pixel text-3xl text-retro-white mb-2">ACCOUNT INIT</h1>
                    <p className="font-mono text-sm text-retro-muted">Join the neural orchestration engine today.</p>
                </div>

                <div className="bg-retro-panel border-3 border-retro-border shadow-pixel-lg p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-retro-muted uppercase tracking-widest ml-1">USER NAME</label>
                            <input
                                type="text"
                                value={name}
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-retro-muted uppercase tracking-widest ml-1">ACCESS KEY (PASSWORD)</label>
                            <input
                                type="password"
                                value={password}
                        ...
                        >
                            {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : "INITIALIZE"}
                        </Button>
                    </form>
                    ...
                    <div className="mt-8 pt-6 border-t font-mono text-[10px] text-retro-dim flex justify-between uppercase tracking-tighter">
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            <span>V2.0 Engine</span>
                        </div>
                    </div>
                </div>

                <p className="mt-8 text-center font-mono text-sm text-retro-muted">
                    Already recognized? <Link href="/login" className="text-retro-cyan hover:underline underline-offset-4">LOG IN</Link>
                </p>
            </motion.div>
        </div>
    );
